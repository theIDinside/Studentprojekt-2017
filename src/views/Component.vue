...
export default {
    ...
    mounted() {
        axios.get('/components/' + this.$route.params.id)
            .then(response => {
    ...
    methods: {
        ...
        updateComponent() {
            ...
            axios.put('/components/' + this.component.id, data)
                .then(response => {
                    if (response.status == '201') {

                        axios.get('/components/' + this.component.id)
                            .then(response => {
        ...
        deleteComponent() {
            axios.delete('/components/' + this.component.id)
                .then(response => {
